...
-- Rebinds keymaps to include copy/paste to system clipboard
vim.keymap.set('v', '<leader>y', '"+y', { desc = 'Yank to system clipboard' })
vim.keymap.set('n', '<leader>p', '"+p', { desc = 'Paste from system clipboard' })

-- Toggel the terminal
-- vim.keymap.set('n', '<C-\\><C-\\>', ':terminal<enter>', { desc = 'Toggel the Terminal' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', 'hx', require('harpoon.mark').add_file, { desc = '[H]arpoon [X]mark' })
      vim.keymap.set('n', 'hu', require('harpoon.mark').rm_file, { desc = '[H]arpoon [U]nmark' })
      vim.keymap.set('n', 'hn', require('harpoon.ui').nav_prev, { desc = '[H]arpoon [N]ext' })
      vim.keymap.set('n', 'hp', require('harpoon.ui').nav_next, { desc = '[H]arpoon [P]revious' })
      vim.keymap.set('n', '<leader>x', ':Telescope harpoon marks<CR>', { desc = '[H]arpoon Marks' })
      --
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      require('mini.starter').setup {
        header = table.concat({
          ' ____  ____  _______        ______   ___ _____ ',
          '|  _ \\|  _ \\| ____\\ \\      / / __ ) / _ \\_   _|',
          '| | | | |_) |  _|  \\ \\ /\\ / /|  _ \\| | | || |  ',
          '| |_| |  _ <| |___  \\ V  V / | |_) | |_| || |  ',
          '|____/|_| \\_\\_____|  \\_/\\_/  |____/ \\___/ |_|  ',
          '',
          '            ######################           ',
          '         ###                     ###-        ',
          '     .###                           ###-     ',
        ...
        items = {
          require('mini.starter').sections.recent_files(10, true), -- second arg 'true' = current dir only
          require('mini.starter').sections.builtin_actions(),
        },
        footer = table.concat({
          '',
          '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
          '  Happy Coding! • ' .. os.date '%Y-%m-%d' .. ' • Press ? for help',
          '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        }, '\n'),
      }
      -- ... and there is more!
